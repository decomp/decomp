...
const use = `
Post-processes Go source code to make it more idiomatic.

Usage:

	go-post [-diff] [-r fixname,...] [-force fixname,...] [FILE.go...]
...
func processFile(filename string, useStdin bool) error {
	...
	for _, fix := range fixes {
		...
		// Note: the go-post rules are not idempotent. As such, run until fix
		// point.
		for fix.f(newFile) {
			fixed = true
